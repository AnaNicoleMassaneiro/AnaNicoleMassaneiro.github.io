...
export class SeoService {
  readonly separator = ' | ';
  readonly title = 'Ana Nicole Massaneiro: Web Developer';
  readonly description = 'A web and mobile developer passionate about learning. <br>A coder and a musician who wants to learn more, grow and explore the world.';
  ...
  setTitle(title: string, prefix: string, addSuffix: boolean = false) {
    ...
    if (addSuffix) {
      result = this.smartConcat(result, 'Ana Nicole Massaneiro: Web Developer');
    }
